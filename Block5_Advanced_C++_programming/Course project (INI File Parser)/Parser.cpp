...
std::string ini_parser::getStringValue(const std::string currentSection, const std::string key, const int lineNumber)
{
...
void ini_parser::printMap(const std::string currentSection, const std::string key)
{
